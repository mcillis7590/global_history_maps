...
const loader = new Loader(process.env.GOOGLE_API_KEY);
let rvMap
let classicalMap
let americasMap
let pcMap
...
console.log(images)
	...
	loader.load().then(function (google) {
		...
		const rvOverlay = new google.maps.GroundOverlay(Object.values(images.river_valley_overlay)[0], rvImageBounds);
		...
		//set the image overlay using the link
		const classicalOverlay = new google.maps.GroundOverlay(Object.values(images.classical_overlay)[0], classicalImageBounds);
		...
		//set the image overlay using the link
		const americasOverlay = new google.maps.GroundOverlay(Object.values(images.americas_overlay)[0], americasImageBounds);
		...
		//set the image overlay using the link
		const pcOverlay = new google.maps.GroundOverlay(Object.values(images.post_classical_overlay)[0], pcImageBounds);
		...
		//set the image overlay using the link
		const medievalOverlay = new google.maps.GroundOverlay(Object.values(images.medieval_europe_overlay)[0], medievalImageBounds);
		...
		//set the image overlay using the link
		const renOverlay = new google.maps.GroundOverlay(Object.values(images.spread_of_renaissance_overlay)[0], renImageBounds);
		...
		//set the image overlay using the link
		const refOverlay = new google.maps.GroundOverlay(Object.values(images.reformation_overlay)[0], refImageBounds);
		...
		//set the image overlay using the link
		const expOverlay = new google.maps.GroundOverlay(Object.values(images.exploration_overlay)[0], expImageBounds);
